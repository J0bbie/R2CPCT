...
#' @format GRanges object containing the cleaned-up genes from GENCODE v35.
#' @docType data
#'
#' @usage data(GENCODE.v35)
#' @source ftp://ftp.ebi.ac.uk/pub/databases/gencode/Gencode_human/release_35/gencode.v35.annotation.gtf.gz
#' @keywords datasets
'GENCODE.v35'
...
#' @format GRanges object containing the cleaned-up non-overlapping exonic regions per gene from GENCODE v35.
#' @docType data
#'
#' @usage data(GENCODE.v35.Exons)
#' @source ftp://ftp.ebi.ac.uk/pub/databases/gencode/Gencode_human/release_35/gencode.v35.annotation.gtf.gz
#' @keywords datasets
'GENCODE.v35.Exons'
...
#'     s <- trimws(strsplit(s, '\n')[[1]])
#'     data.frame(Signature = s[[1]], proposedAetiology = s[[8]])
#'   }))
...
#' # Combine lists -----------------------------------------------------------
#'
#' proposedAetiologyCOSMICv3.1 <- rbind(sigs.SBS, sigs.DBS, sigs.ID)
#'
#' # Group signatures based on common proposed aetiology together.
#' proposedAetiologyCOSMICv3.1 <- proposedAetiologyCOSMICv3.1 %>%
...
#'   dplyr::ungroup()
#'
#' usethis::use_data(proposedAetiologyCOSMICv3.1)
#' @format Tibble containing the COSMIC (v3.1) proposed signatures aetiologies.
#' @docType data
#'
#' @usage data(proposedAetiologyCOSMICv3.1)
#' @source COSMIC
#' @keywords datasets
'proposedAetiologyCOSMICv3.1'
...
#'
#' # Convert to GRanges.
#' proteinDomains <- GenomicRanges::makeGRangesFromDataFrame(proteinDomains, keep.extra.columns = T, seqnames.field = 'protein_ID', start.field = 'prot_start', end.field = 'prot_end')
#'
